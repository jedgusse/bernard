...
def Rolling_Delta(sample_length, feat_amount, invalid_words, step_size):
	...
	authors, titles, texts, raw_counts, features = vectorize("/Users/.../benchmark_corpus", sample_length, feat_amount, invalid_words)
	...
	for text_index, filename in enumerate(glob.glob("/Users/.../test_corpus/*")):
